  ...
  <div class="page">
    ...
    ${d.competitors && d.competitors.marketSize ? `<div class="section"><h2>${rico('barChart')} Competitor Benchmark</h2>
      ...
      <div class="meta" style="margin-top:10px">
        <span class="k">Reviews</span><span>${d.reviewCount ?? 0} <span style="color:#718096">${d.competitors.reviewTarget ? `· ~${d.competitors.reviewTarget.needed} more to pass ${d.competitors.reviewTarget.passN} competitor${d.competitors.reviewTarget.passN === 1 ? '' : 's'}` : `vs ${d.competitors.medReviews} typical`}</span></span>
